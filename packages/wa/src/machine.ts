...
const PREVIOUS_STEP: Partial<Record<Step, Step>> = {
  ...
  confirm_file_metadata: "ask_cover",
  ask_metadata_correction: "confirm_file_metadata",
  ask_producers: "confirm_file_metadata",
  ask_producer_position: "ask_producers",
  confirm_external_producer: "ask_producers",
  ask_genres: "ask_producers",
  ask_date: "ask_genres",
  ask_audio: "ask_release_format",
  ask_cover: "ask_audio",
  confirm: "ask_date",
};
...
function promptFor(step: Step) {
  const prompts: Record<Step, string> = {
    ...
    confirm_file_metadata: "Confere o título, participantes e cargos identificados pelo arquivo.",
    ask_metadata_correction: "Manda a lista correta com Titulo e Participantes.",
    ask_producers: "Quem produziu a música?",
    ask_producer_position: "Em que posição o produtor entra nos créditos?",
    confirm_external_producer: "Confirma a lista com o produtor incluído?",
